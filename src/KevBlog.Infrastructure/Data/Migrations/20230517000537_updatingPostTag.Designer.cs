...
namespace API.Migrations
{
    ...
    [Migration("20230517000537_updatingPostTag")]
    partial class updatingPostTag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PostTag", b =>
                {
                    b.HasOne("KevBlog.Domain.Entities.Post", null)
                        .WithMany()
                        .HasForeignKey("PostsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KevBlog.Domain.Entities.Tag", null)
                        .WithMany()
